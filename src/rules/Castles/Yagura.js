...
var Yagura = [
        ...
        {///////Bishop
            ...
            "condition": function(R) {	
                ...
                if((this.possibleMoves.includes("06") && this.player=="0") || (this.possibleMoves.includes("82") && this.player=="1")){possible=true}
                R.when(
                    notPositioned &&
                    possible &&
                    this.possibleMoves!="" && this.player==this.state.ctx.currentPlayer && this.isHand=="0"
        ...
        {///////King
            ...
            "condition": function(R) {	
                ...
                if((this.possibleMoves.includes("05") && this.player=="0") || (this.possibleMoves.includes("83") && this.player=="1")){possible=true}
                R.when(
                    notPositioned &&
                    possible &&
                    this.possibleMoves!="" && this.player==this.state.ctx.currentPlayer && this.isHand=="0"
